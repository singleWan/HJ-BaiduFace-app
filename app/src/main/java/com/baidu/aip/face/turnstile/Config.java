...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "oFvU9eaEssVrTUgiKSj8t776";
    public static String secretKey = "zkr4vpPX8k4lGhXErqbLaq85ajCvxDY0";
    public static String licenseID = "HiJogging-face-android";
     ...
     */
    public static String groupID = "login_gym";
